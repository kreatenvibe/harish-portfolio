              ...
              <div className="space-y-8">
                ...
                <div className="flex flex-wrap items-center gap-3">
                  {beforeItems.map(({ label, Icon }) => (
                    <span
                      key={label}
                      className="inline-flex items-center gap-2 rounded-full border border-foreground/10 bg-surface px-4 py-2 text-sm font-medium text-muted line-through decoration-foreground/25"
                    >
